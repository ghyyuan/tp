...
public class Messages {
    ...
    // Backwards-compatible aliases for refactoring
    public static final String MESSAGE_INVALID_PERSON_DISPLAYED_INDEX = MESSAGE_INVALID_APPLICATION_DISPLAYED_INDEX;
    public static final String MESSAGE_PERSONS_LISTED_OVERVIEW = MESSAGE_APPLICATIONS_LISTED_OVERVIEW;
